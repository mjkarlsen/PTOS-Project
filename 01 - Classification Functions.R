...
complications_func <- function(col) {
  col_value <-  case.(col == 1,   "None",
                      col == 20,  "ARDS",
                      col == 21,  "Acute Respirtaory Failure",
                      ...
                      col == 100, "Pneumonia",
                      col == 32,  "Extremity Compartment Syndrome",
