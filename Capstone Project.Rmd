...
pto_df <- raw_data %>% 
  ...
  mutate_across.(starts_with.('discharge_status_', discharge_status_func), 
                 # discharge_feeding = d_disabl_f, 
                 # discharge_locomotion = d_disabl_l, 
                 # discharge_expression = d_disabl_e,
                 # discharge_transfer_mobility = d_disabl_t, 
                 # discharge_social_interaction = d_disabl_s,
                 ) %>% 
  mutate.(dob = ifelse(is.na(dob), as.character(mdy(injury_dt)-years(age)), dob),
          ...
          injury_location = injury_location_func(injury_location),
          ...
          # admission_time = ifelse(is.na(admission_time), emergency_dpt_time, arrival_time),
          # admission_dt = ifelse(is.na(admission_dt), emergency_dpt_dt, arrival_dt),
