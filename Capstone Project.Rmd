...
#   select.(id, fltr_fasciotomy, sex, race, age_in_yrs, injury_desc, peds_adult_flag) %>% 
#   distinct.()
# 
...
# patient_period_list <- list('chapter_desc', 
#                          'subchapter_desc')
...
# map.(patient_period_list, ~ bar_func(fx_proc, .x))
